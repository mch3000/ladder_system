...
def all_pairs(teams,costs,score=0.0):
    ...
    print(ws,'Calling all_pairs, new state_level: ',state_level)
    ...
    for i in range(1,len(teams)):
        ...
        if current_state[state_level]<i or (current_state[state_level]==i and current_state[ml]>0):
            ...
            s = costs[ta][teams[i]]
            print(ws,'Next pair: (team 1, team 2, score)',ta,teams[i],s)
            ...
            # else stop searching this branch and go back up
                ...
                print(ws,'Going back up, total score too high:',s+score )
                yield None
